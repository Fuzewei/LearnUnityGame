...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			Property pAvatar_inBattle = new Property();
			...
			pAvatarModule.propertys["inBattle"] = pAvatar_inBattle; 

			pAvatarModule.usePropertyDescrAlias = true;
			pAvatarModule.idpropertys[(UInt16)pAvatar_inBattle.aliasID] = pAvatar_inBattle;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(inBattle / 12).");
			...
			Property pAvatar_moveDirection = new Property();
			...
			pAvatarModule.usePropertyDescrAlias = true;
			pAvatarModule.idpropertys[(UInt16)pAvatar_moveDirection.aliasID] = pAvatar_moveDirection;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(moveDirection / 15).");

			Property pAvatar_moveInfo = new Property();
			...
			pAvatarModule.usePropertyDescrAlias = true;
			pAvatarModule.idpropertys[(UInt16)pAvatar_moveInfo.aliasID] = pAvatar_moveInfo;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(moveInfo / 16).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(moveSpeed / 17).");

			Property pAvatar_moveType = new Property();
			...
			pAvatarModule.propertys["moveType"] = pAvatar_moveType; 

			pAvatarModule.usePropertyDescrAlias = true;
			pAvatarModule.idpropertys[(UInt16)pAvatar_moveType.aliasID] = pAvatar_moveType;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(moveType / 14).");
			...
			List<DATATYPE_BASE> pAvatar_confirmMoveTimeStamp_args = new List<DATATYPE_BASE>();
			pAvatar_confirmMoveTimeStamp_args.Add(EntityDef.id2datatypes[13]);

			Method pAvatar_confirmMoveTimeStamp = new Method();
			pAvatar_confirmMoveTimeStamp.name = "confirmMoveTimeStamp";
			pAvatar_confirmMoveTimeStamp.methodUtype = 38;
			pAvatar_confirmMoveTimeStamp.aliasID = 1;
			pAvatar_confirmMoveTimeStamp.args = pAvatar_confirmMoveTimeStamp_args;

			pAvatarModule.methods["confirmMoveTimeStamp"] = pAvatar_confirmMoveTimeStamp; 
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(confirmMoveTimeStamp / 38).");
			...
			pAvatar_serverRequestUseSkill_args.Add(EntityDef.id2datatypes[8]);
			...
			pAvatarModule.methods["serverRequestUseSkill"] = pAvatar_serverRequestUseSkill; 
			pAvatarModule.useMethodDescrAlias = true;
			...
			pAvatar_serverSkillFinish.methodUtype = 21;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(serverSkillFinish / 21).");

			List<DATATYPE_BASE> pAvatar_setPositionRotation_args = new List<DATATYPE_BASE>();
			pAvatar_setPositionRotation_args.Add(EntityDef.id2datatypes[4]);
			pAvatar_setPositionRotation_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_setPositionRotation_args.Add(EntityDef.id2datatypes[16]);

			Method pAvatar_setPositionRotation = new Method();
			pAvatar_setPositionRotation.name = "setPositionRotation";
			pAvatar_setPositionRotation.methodUtype = 31;
			pAvatar_setPositionRotation.aliasID = 11;
			pAvatar_setPositionRotation.args = pAvatar_setPositionRotation_args;

			pAvatarModule.methods["setPositionRotation"] = pAvatar_setPositionRotation; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_setPositionRotation.aliasID] = pAvatar_setPositionRotation;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(setPositionRotation / 31).");
			...
			pAvatar_skillNodeCallClient_args.Add(EntityDef.id2datatypes[8]);
			pAvatar_skillNodeCallClient_args.Add(EntityDef.id2datatypes[34]);
			...
			pAvatar_startP3ClientMove.methodUtype = 39;
			pAvatar_startP3ClientMove.aliasID = 13;
			pAvatar_startP3ClientMove.args = pAvatar_startP3ClientMove_args;

			pAvatarModule.methods["startP3ClientMove"] = pAvatar_startP3ClientMove; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_startP3ClientMove.aliasID] = pAvatar_startP3ClientMove;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(startP3ClientMove / 39).");

			List<DATATYPE_BASE> pAvatar_stopP3ClientMove_args = new List<DATATYPE_BASE>();
			pAvatar_stopP3ClientMove_args.Add(EntityDef.id2datatypes[13]);

			Method pAvatar_stopP3ClientMove = new Method();
			pAvatar_stopP3ClientMove.name = "stopP3ClientMove";
			pAvatar_stopP3ClientMove.methodUtype = 40;
			pAvatar_stopP3ClientMove.aliasID = 14;
			pAvatar_stopP3ClientMove.args = pAvatar_stopP3ClientMove_args;

			pAvatarModule.methods["stopP3ClientMove"] = pAvatar_stopP3ClientMove; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_stopP3ClientMove.aliasID] = pAvatar_stopP3ClientMove;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(stopP3ClientMove / 40).");
			...
			pAvatar_clientRequestUseSkill_args.Add(EntityDef.id2datatypes[8]);

			Method pAvatar_clientRequestUseSkill = new Method();
			pAvatar_clientRequestUseSkill.name = "clientRequestUseSkill";
			pAvatar_clientRequestUseSkill.methodUtype = 14;
			pAvatar_clientRequestUseSkill.aliasID = -1;
			pAvatar_clientRequestUseSkill.args = pAvatar_clientRequestUseSkill_args;

			pAvatarModule.methods["clientRequestUseSkill"] = pAvatar_clientRequestUseSkill; 
			pAvatarModule.cell_methods["clientRequestUseSkill"] = pAvatar_clientRequestUseSkill;
			...
			List<DATATYPE_BASE> pAvatar_p3UpdatePosition_args = new List<DATATYPE_BASE>();
			pAvatar_p3UpdatePosition_args.Add(EntityDef.id2datatypes[13]);
			pAvatar_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);

			Method pAvatar_p3UpdatePosition = new Method();
			pAvatar_p3UpdatePosition.name = "p3UpdatePosition";
			pAvatar_p3UpdatePosition.methodUtype = 33;
			pAvatar_p3UpdatePosition.aliasID = -1;
			pAvatar_p3UpdatePosition.args = pAvatar_p3UpdatePosition_args;

			pAvatarModule.methods["p3UpdatePosition"] = pAvatar_p3UpdatePosition; 
			pAvatarModule.cell_methods["p3UpdatePosition"] = pAvatar_p3UpdatePosition;

			pAvatarModule.idcell_methods[pAvatar_p3UpdatePosition.methodUtype] = pAvatar_p3UpdatePosition;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(p3UpdatePosition / 33).");
			...
			List<DATATYPE_BASE> pAvatar_setInBattle_args = new List<DATATYPE_BASE>();
			pAvatar_setInBattle_args.Add(EntityDef.id2datatypes[13]);
			pAvatar_setInBattle_args.Add(EntityDef.id2datatypes[2]);

			Method pAvatar_setInBattle = new Method();
			pAvatar_setInBattle.name = "setInBattle";
			pAvatar_setInBattle.methodUtype = 36;
			pAvatar_setInBattle.aliasID = -1;
			pAvatar_setInBattle.args = pAvatar_setInBattle_args;

			pAvatarModule.methods["setInBattle"] = pAvatar_setInBattle; 
			pAvatarModule.cell_methods["setInBattle"] = pAvatar_setInBattle;

			pAvatarModule.idcell_methods[pAvatar_setInBattle.methodUtype] = pAvatar_setInBattle;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(setInBattle / 36).");
			...
			pAvatar_setPostionAndRotation.methodUtype = 34;
			pAvatar_setPostionAndRotation.aliasID = -1;
			pAvatar_setPostionAndRotation.args = pAvatar_setPostionAndRotation_args;

			pAvatarModule.methods["setPostionAndRotation"] = pAvatar_setPostionAndRotation; 
			pAvatarModule.cell_methods["setPostionAndRotation"] = pAvatar_setPostionAndRotation;

			pAvatarModule.idcell_methods[pAvatar_setPostionAndRotation.methodUtype] = pAvatar_setPostionAndRotation;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(setPostionAndRotation / 34).");
			...
			pAvatar_skillNodeCallServer_args.Add(EntityDef.id2datatypes[8]);
			pAvatar_skillNodeCallServer_args.Add(EntityDef.id2datatypes[34]);
			...
			pAvatarModule.methods["skillNodeCallServer"] = pAvatar_skillNodeCallServer; 
			pAvatarModule.cell_methods["skillNodeCallServer"] = pAvatar_skillNodeCallServer;
			...
			pAvatar_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[4]);
			pAvatar_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pAvatar_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[2]);

			Method pAvatar_updateAvatarMoveState = new Method();
			pAvatar_updateAvatarMoveState.name = "updateAvatarMoveState";
			pAvatar_updateAvatarMoveState.methodUtype = 37;
			pAvatar_updateAvatarMoveState.aliasID = -1;
			pAvatar_updateAvatarMoveState.args = pAvatar_updateAvatarMoveState_args;

			pAvatarModule.methods["updateAvatarMoveState"] = pAvatar_updateAvatarMoveState; 
			pAvatarModule.cell_methods["updateAvatarMoveState"] = pAvatar_updateAvatarMoveState;

			pAvatarModule.idcell_methods[pAvatar_updateAvatarMoveState.methodUtype] = pAvatar_updateAvatarMoveState;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(updateAvatarMoveState / 37).");
			...
			pAvatar_updateMovetype_args.Add(EntityDef.id2datatypes[4]);

			Method pAvatar_updateMovetype = new Method();
			pAvatar_updateMovetype.name = "updateMovetype";
			pAvatar_updateMovetype.methodUtype = 35;
			pAvatar_updateMovetype.aliasID = -1;
			pAvatar_updateMovetype.args = pAvatar_updateMovetype_args;

			pAvatarModule.methods["updateMovetype"] = pAvatar_updateMovetype; 
			pAvatarModule.cell_methods["updateMovetype"] = pAvatar_updateMovetype;

			pAvatarModule.idcell_methods[pAvatar_updateMovetype.methodUtype] = pAvatar_updateMovetype;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(updateMovetype / 35).");
			...
			pAvatar_updatePosition.methodUtype = 32;
			...
			pAvatarModule.cell_methods["updatePosition"] = pAvatar_updatePosition;

			pAvatarModule.idcell_methods[pAvatar_updatePosition.methodUtype] = pAvatar_updatePosition;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(updatePosition / 32).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(helloCB / 43).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(say / 42).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(hello / 41).");
			...
			pTestNoBase_helloCB.methodUtype = 45;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(helloCB / 45).");
			...
			pTestNoBase_hello.methodUtype = 44;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(hello / 44).");
			...
			Property pMonster_aiMoviePath = new Property();
			pMonster_aiMoviePath.name = "aiMoviePath";
			pMonster_aiMoviePath.properUtype = 43;
			pMonster_aiMoviePath.properFlags = 4;
			pMonster_aiMoviePath.aliasID = 8;
			pMonster_aiMoviePath.defaultVal = EntityDef.id2datatypes[24].parseDefaultValStr("[]");
			pMonsterModule.propertys["aiMoviePath"] = pMonster_aiMoviePath; 

			pMonsterModule.usePropertyDescrAlias = true;
			pMonsterModule.idpropertys[(UInt16)pMonster_aiMoviePath.aliasID] = pMonster_aiMoviePath;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(aiMoviePath / 43).");

			Property pMonster_aiMoviePathIndex = new Property();
			pMonster_aiMoviePathIndex.name = "aiMoviePathIndex";
			pMonster_aiMoviePathIndex.properUtype = 44;
			pMonster_aiMoviePathIndex.properFlags = 4;
			pMonster_aiMoviePathIndex.aliasID = 9;
			UInt32 Monster_aiMoviePathIndex_defval;
			UInt32.TryParse("0", out Monster_aiMoviePathIndex_defval);
			pMonster_aiMoviePathIndex.defaultVal = Monster_aiMoviePathIndex_defval;
			pMonsterModule.propertys["aiMoviePathIndex"] = pMonster_aiMoviePathIndex; 

			pMonsterModule.usePropertyDescrAlias = true;
			pMonsterModule.idpropertys[(UInt16)pMonster_aiMoviePathIndex.aliasID] = pMonster_aiMoviePathIndex;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(aiMoviePathIndex / 44).");

			Property pMonster_aiMovieToPoint = new Property();
			pMonster_aiMovieToPoint.name = "aiMovieToPoint";
			pMonster_aiMovieToPoint.properUtype = 42;
			pMonster_aiMovieToPoint.properFlags = 4;
			pMonster_aiMovieToPoint.aliasID = 10;
			Vector3 Monster_aiMovieToPoint_defval = new Vector3();
			pMonster_aiMovieToPoint.defaultVal = Monster_aiMovieToPoint_defval;
			pMonsterModule.propertys["aiMovieToPoint"] = pMonster_aiMovieToPoint; 

			pMonsterModule.usePropertyDescrAlias = true;
			pMonsterModule.idpropertys[(UInt16)pMonster_aiMovieToPoint.aliasID] = pMonster_aiMovieToPoint;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(aiMovieToPoint / 42).");
			...
			pMonster_aiMovingType.aliasID = 11;
			UInt32 Monster_aiMovingType_defval;
			UInt32.TryParse("0", out Monster_aiMovingType_defval);
			pMonster_aiMovingType.defaultVal = Monster_aiMovingType_defval;
			pMonsterModule.propertys["aiMovingType"] = pMonster_aiMovingType; 
			...
			pMonster_confirmTime.properUtype = 51;
			pMonster_confirmTime.properFlags = 4;
			pMonster_confirmTime.aliasID = 12;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(confirmTime / 51).");

			Property pMonster_controlId = new Property();
			pMonster_controlId.name = "controlId";
			pMonster_controlId.properUtype = 52;
			pMonster_controlId.properFlags = 4;
			pMonster_controlId.aliasID = 13;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(controlId / 52).");
			...
			pMonsterModule.propertys["inBattle"] = pMonster_inBattle; 
			...
			pMonster_modelScale.aliasID = 18;
			...
			pMonster_moveDirection.properUtype = 48;
			pMonster_moveDirection.properFlags = 4;
			pMonster_moveDirection.aliasID = 19;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveDirection / 48).");

			Property pMonster_moveInfo = new Property();
			pMonster_moveInfo.name = "moveInfo";
			pMonster_moveInfo.properUtype = 49;
			pMonster_moveInfo.properFlags = 4;
			pMonster_moveInfo.aliasID = 20;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveInfo / 49).");

			Property pMonster_moveSpeed = new Property();
			pMonster_moveSpeed.name = "moveSpeed";
			pMonster_moveSpeed.properUtype = 50;
			pMonster_moveSpeed.properFlags = 4;
			pMonster_moveSpeed.aliasID = 21;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveSpeed / 50).");

			Property pMonster_moveType = new Property();
			pMonster_moveType.name = "moveType";
			pMonster_moveType.properUtype = 47;
			pMonster_moveType.properFlags = 4;
			pMonster_moveType.aliasID = 22;
			...
			Property pMonster_targetID = new Property();
			pMonster_targetID.name = "targetID";
			pMonster_targetID.properUtype = 40;
			pMonster_targetID.properFlags = 4;
			pMonster_targetID.aliasID = 26;
			Int32 Monster_targetID_defval;
			Int32.TryParse("0", out Monster_targetID_defval);
			pMonster_targetID.defaultVal = Monster_targetID_defval;
			pMonsterModule.propertys["targetID"] = pMonster_targetID; 

			pMonsterModule.usePropertyDescrAlias = true;
			pMonsterModule.idpropertys[(UInt16)pMonster_targetID.aliasID] = pMonster_targetID;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(targetID / 40).");

			Property pMonster_uid = new Property();
			pMonster_uid.name = "uid";
			pMonster_uid.properUtype = 41004;
			pMonster_uid.properFlags = 4;
			pMonster_uid.aliasID = 27;
			...
			pMonster_chaseTarget.methodUtype = 63;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(chaseTarget / 63).");
			...
			pMonster_confirmMoveTimeStamp.methodUtype = 73;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(confirmMoveTimeStamp / 73).");

			List<DATATYPE_BASE> pMonster_fightMove_args = new List<DATATYPE_BASE>();
			pMonster_fightMove_args.Add(EntityDef.id2datatypes[6]);
			pMonster_fightMove_args.Add(EntityDef.id2datatypes[16]);

			Method pMonster_fightMove = new Method();
			pMonster_fightMove.name = "fightMove";
			pMonster_fightMove.methodUtype = 66;
			pMonster_fightMove.aliasID = 3;
			pMonster_fightMove.args = pMonster_fightMove_args;

			pMonsterModule.methods["fightMove"] = pMonster_fightMove; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_fightMove.aliasID] = pMonster_fightMove;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(fightMove / 66).");
			...
			pMonster_randomWalk.methodUtype = 62;
			pMonster_randomWalk.aliasID = 4;
			pMonster_randomWalk.args = pMonster_randomWalk_args;

			pMonsterModule.methods["randomWalk"] = pMonster_randomWalk; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_randomWalk.aliasID] = pMonster_randomWalk;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(randomWalk / 62).");
			...
			pMonster_recvDamage.methodUtype = 51;
			pMonster_recvDamage.aliasID = 5;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(recvDamage / 51).");
			...
			pMonster_serverRequestUseSkill_args.Add(EntityDef.id2datatypes[8]);

			Method pMonster_serverRequestUseSkill = new Method();
			pMonster_serverRequestUseSkill.name = "serverRequestUseSkill";
			pMonster_serverRequestUseSkill.methodUtype = 53;
			pMonster_serverRequestUseSkill.aliasID = 6;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(serverRequestUseSkill / 53).");
			...
			pMonster_serverSkillFinish.methodUtype = 54;
			pMonster_serverSkillFinish.aliasID = 7;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(serverSkillFinish / 54).");
			...
			pMonster_skillNodeCallClient_args.Add(EntityDef.id2datatypes[8]);
			pMonster_skillNodeCallClient_args.Add(EntityDef.id2datatypes[34]);

			Method pMonster_skillNodeCallClient = new Method();
			pMonster_skillNodeCallClient.name = "skillNodeCallClient";
			pMonster_skillNodeCallClient.methodUtype = 52;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(skillNodeCallClient / 52).");
			...
			pMonster_startP3ClientMove.methodUtype = 74;
			pMonster_startP3ClientMove.aliasID = 9;
			pMonster_startP3ClientMove.args = pMonster_startP3ClientMove_args;

			pMonsterModule.methods["startP3ClientMove"] = pMonster_startP3ClientMove; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_startP3ClientMove.aliasID] = pMonster_startP3ClientMove;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(startP3ClientMove / 74).");
			...
			pMonster_stopMotion.methodUtype = 65;
			pMonster_stopMotion.aliasID = 10;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(stopMotion / 65).");

			List<DATATYPE_BASE> pMonster_stopP3ClientMove_args = new List<DATATYPE_BASE>();
			pMonster_stopP3ClientMove_args.Add(EntityDef.id2datatypes[13]);

			Method pMonster_stopP3ClientMove = new Method();
			pMonster_stopP3ClientMove.name = "stopP3ClientMove";
			pMonster_stopP3ClientMove.methodUtype = 75;
			pMonster_stopP3ClientMove.aliasID = 11;
			pMonster_stopP3ClientMove.args = pMonster_stopP3ClientMove_args;

			pMonsterModule.methods["stopP3ClientMove"] = pMonster_stopP3ClientMove; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_stopP3ClientMove.aliasID] = pMonster_stopP3ClientMove;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(stopP3ClientMove / 75).");
			...
			pMonster_useSkill.methodUtype = 64;
			pMonster_useSkill.aliasID = 12;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(useSkill / 64).");
			...
			pMonster_clientRequestUseSkill_args.Add(EntityDef.id2datatypes[8]);

			Method pMonster_clientRequestUseSkill = new Method();
			pMonster_clientRequestUseSkill.name = "clientRequestUseSkill";
			pMonster_clientRequestUseSkill.methodUtype = 47;
			pMonster_clientRequestUseSkill.aliasID = -1;
			pMonster_clientRequestUseSkill.args = pMonster_clientRequestUseSkill_args;

			pMonsterModule.methods["clientRequestUseSkill"] = pMonster_clientRequestUseSkill; 
			pMonsterModule.cell_methods["clientRequestUseSkill"] = pMonster_clientRequestUseSkill;

			pMonsterModule.idcell_methods[pMonster_clientRequestUseSkill.methodUtype] = pMonster_clientRequestUseSkill;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(clientRequestUseSkill / 47).");

			List<DATATYPE_BASE> pMonster_p3UpdatePosition_args = new List<DATATYPE_BASE>();
			pMonster_p3UpdatePosition_args.Add(EntityDef.id2datatypes[13]);
			pMonster_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);
			pMonster_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);
			pMonster_p3UpdatePosition_args.Add(EntityDef.id2datatypes[16]);

			Method pMonster_p3UpdatePosition = new Method();
			pMonster_p3UpdatePosition.name = "p3UpdatePosition";
			pMonster_p3UpdatePosition.methodUtype = 68;
			pMonster_p3UpdatePosition.aliasID = -1;
			pMonster_p3UpdatePosition.args = pMonster_p3UpdatePosition_args;

			pMonsterModule.methods["p3UpdatePosition"] = pMonster_p3UpdatePosition; 
			pMonsterModule.cell_methods["p3UpdatePosition"] = pMonster_p3UpdatePosition;

			pMonsterModule.idcell_methods[pMonster_p3UpdatePosition.methodUtype] = pMonster_p3UpdatePosition;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(p3UpdatePosition / 68).");

			List<DATATYPE_BASE> pMonster_setInBattle_args = new List<DATATYPE_BASE>();
			pMonster_setInBattle_args.Add(EntityDef.id2datatypes[13]);
			pMonster_setInBattle_args.Add(EntityDef.id2datatypes[2]);

			Method pMonster_setInBattle = new Method();
			pMonster_setInBattle.name = "setInBattle";
			pMonster_setInBattle.methodUtype = 71;
			pMonster_setInBattle.aliasID = -1;
			pMonster_setInBattle.args = pMonster_setInBattle_args;

			pMonsterModule.methods["setInBattle"] = pMonster_setInBattle; 
			pMonsterModule.cell_methods["setInBattle"] = pMonster_setInBattle;

			pMonsterModule.idcell_methods[pMonster_setInBattle.methodUtype] = pMonster_setInBattle;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(setInBattle / 71).");
			...
			pMonster_setPostionAndRotation.methodUtype = 69;
			pMonster_setPostionAndRotation.aliasID = -1;
			pMonster_setPostionAndRotation.args = pMonster_setPostionAndRotation_args;

			pMonsterModule.methods["setPostionAndRotation"] = pMonster_setPostionAndRotation; 
			pMonsterModule.cell_methods["setPostionAndRotation"] = pMonster_setPostionAndRotation;

			pMonsterModule.idcell_methods[pMonster_setPostionAndRotation.methodUtype] = pMonster_setPostionAndRotation;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(setPostionAndRotation / 69).");
			...
			pMonster_skillNodeCallServer_args.Add(EntityDef.id2datatypes[8]);
			pMonster_skillNodeCallServer_args.Add(EntityDef.id2datatypes[34]);

			Method pMonster_skillNodeCallServer = new Method();
			pMonster_skillNodeCallServer.name = "skillNodeCallServer";
			pMonster_skillNodeCallServer.methodUtype = 48;
			pMonster_skillNodeCallServer.aliasID = -1;
			pMonster_skillNodeCallServer.args = pMonster_skillNodeCallServer_args;

			pMonsterModule.methods["skillNodeCallServer"] = pMonster_skillNodeCallServer; 
			pMonsterModule.cell_methods["skillNodeCallServer"] = pMonster_skillNodeCallServer;

			pMonsterModule.idcell_methods[pMonster_skillNodeCallServer.methodUtype] = pMonster_skillNodeCallServer;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(skillNodeCallServer / 48).");

			List<DATATYPE_BASE> pMonster_updateAvatarMoveState_args = new List<DATATYPE_BASE>();
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[13]);
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[4]);
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[16]);
			pMonster_updateAvatarMoveState_args.Add(EntityDef.id2datatypes[2]);

			Method pMonster_updateAvatarMoveState = new Method();
			pMonster_updateAvatarMoveState.name = "updateAvatarMoveState";
			pMonster_updateAvatarMoveState.methodUtype = 72;
			pMonster_updateAvatarMoveState.aliasID = -1;
			pMonster_updateAvatarMoveState.args = pMonster_updateAvatarMoveState_args;

			pMonsterModule.methods["updateAvatarMoveState"] = pMonster_updateAvatarMoveState; 
			pMonsterModule.cell_methods["updateAvatarMoveState"] = pMonster_updateAvatarMoveState;

			pMonsterModule.idcell_methods[pMonster_updateAvatarMoveState.methodUtype] = pMonster_updateAvatarMoveState;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(updateAvatarMoveState / 72).");
			...
			pMonster_updateMovetype_args.Add(EntityDef.id2datatypes[4]);

			Method pMonster_updateMovetype = new Method();
			pMonster_updateMovetype.name = "updateMovetype";
			pMonster_updateMovetype.methodUtype = 70;
			pMonster_updateMovetype.aliasID = -1;
			pMonster_updateMovetype.args = pMonster_updateMovetype_args;

			pMonsterModule.methods["updateMovetype"] = pMonster_updateMovetype; 
			pMonsterModule.cell_methods["updateMovetype"] = pMonster_updateMovetype;

			pMonsterModule.idcell_methods[pMonster_updateMovetype.methodUtype] = pMonster_updateMovetype;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(updateMovetype / 70).");
			...
			pMonster_updatePosition_args.Add(EntityDef.id2datatypes[16]);
			pMonster_updatePosition_args.Add(EntityDef.id2datatypes[16]);
			pMonster_updatePosition_args.Add(EntityDef.id2datatypes[16]);

			Method pMonster_updatePosition = new Method();
			pMonster_updatePosition.name = "updatePosition";
			pMonster_updatePosition.methodUtype = 67;
			pMonster_updatePosition.aliasID = -1;
			pMonster_updatePosition.args = pMonster_updatePosition_args;

			pMonsterModule.methods["updatePosition"] = pMonster_updatePosition; 
			pMonsterModule.cell_methods["updatePosition"] = pMonster_updatePosition;

			pMonsterModule.idcell_methods[pMonster_updatePosition.methodUtype] = pMonster_updatePosition;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(updatePosition / 67).");
		...
		public static void initDefTypes()
		{
			...
			{
				UInt16 utype = 24;
				string typeName = "PATH_POINTS";
				DATATYPE_PATH_POINTS datatype = new DATATYPE_PATH_POINTS();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 33;
				string typeName = "MOVE_INFOS";
				DATATYPE_MOVE_INFOS datatype = new DATATYPE_MOVE_INFOS();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}

			{
				...
				DATATYPE_TABLE datatype = new DATATYPE_TABLE();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}

			{
				...
				DATATYPE_AnonymousArray_37 datatype = new DATATYPE_AnonymousArray_37();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 39;
				string typeName = "AnonymousArray_39";
				string name = "ENTITY_COMPONENT";
				DATATYPE_BASE val = null;
				EntityDef.datatypes.TryGetValue(name, out val);
				EntityDef.datatypes[typeName] = val;
