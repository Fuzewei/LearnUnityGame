...
namespace KBEngine
{
	...
	public class EntityBaseEntityCall_AvatarBase : EntityCall
	{
		...
		{
			component1 = new EntityBaseEntityCall_TestBase(22, id);
			component2 = new EntityBaseEntityCall_TestBase(27, id);
			component3 = new EntityBaseEntityCall_TestNoBaseBase(28, id);
	...
	public class EntityCellEntityCall_AvatarBase : EntityCall
	{
		...
		{
			component1 = new EntityCellEntityCall_TestBase(22, id);
			component2 = new EntityCellEntityCall_TestBase(27, id);
			component3 = new EntityCellEntityCall_TestNoBaseBase(28, id);
